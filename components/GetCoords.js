async function fetchRouteData(originLatLong, waypointLatLong, destinationLatLong) {
    ...
    const apiKey = "AIzaSyBSm8FeujWMFA5t3Exz_YXYSMJ6N5E-jYA"; // Replace with your API key
  
    try {
        const response = await fetch(
            `${proxyUrl}https://maps.googleapis.com/maps/api/directions/json?origin=${origin}&waypoints=${waypoint}&destination=${destination}&key=${apiKey}&mode=driving`,
        );
        ...
        console.log('fetch route data', data);
